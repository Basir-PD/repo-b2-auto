      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div ref={imageRef} className="relative">
            <div className="aspect-square rounded-2xl bg-gradient-to-br from-indigo-100 to-violet-50 relative z-10 overflow-hidden shadow-2xl border-4 border-white -skew-x-3 hover:skew-x-0 transition-transform duration-500">
              {/* Placeholder for About Image */}
              <div className="absolute inset-0 flex items-center justify-center text-indigo-200 font-black text-4xl uppercase opacity-20 -rotate-12">
                B2 Auto
              </div>
            </div>
