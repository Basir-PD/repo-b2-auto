        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-8 sm:mb-10 md:mb-12">
          ...
          <div className="space-y-4 sm:space-y-5 md:space-y-6 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-green-600 rounded-lg -skew-x-6 flex items-center justify-center">
            ...
            <div className="flex gap-3 sm:gap-4">
              <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-slate-900 flex items-center justify-center hover:bg-green-600 hover:text-white transition-all duration-300 hover:-translate-y-1">
          ...
          <div>
            ...
            <ul className="space-y-2.5 sm:space-y-3 md:space-y-4">
              <li><Link href="#services" className="text-sm sm:text-base hover:text-green-400 transition-colors font-medium">Services</Link></li>
              <li><Link href="#about" className="text-sm sm:text-base hover:text-green-400 transition-colors font-medium">{t.header.about}</Link></li>
              <li><Link href="#faq" className="text-sm sm:text-base hover:text-green-400 transition-colors font-medium">FAQ</Link></li>
              <li><Link href="#contact" className="text-sm sm:text-base hover:text-green-400 transition-colors font-medium">{t.footer.contactUs}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 sm:space-y-3 md:space-y-4">
              <li className="flex items-start gap-2 sm:gap-3">
                <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-green-400 mt-0.5 sm:mt-1 flex-shrink-0" />
              ...
              <li className="flex items-start gap-2 sm:gap-3">
                ...
                <span className="text-sm sm:text-base text-slate-400 font-medium">Montreal, QC</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 sm:space-y-3 md:space-y-4">
              <li className="flex items-start gap-2 sm:gap-3">
                <Clock className="w-4 h-4 sm:w-5 sm:h-5 text-green-400 mt-0.5 sm:mt-1 flex-shrink-0" />
                <div>
