...
export const en: Copy = {
  ...
  home: {
    ...
    whatsappPrefill: "Hi! I'd like a quote for my vehicle.",
    ...
    serviceArea: {
      title: "Scrap car removal in Montreal, Laval, the North Shore & West Island",
      lead: "Towing is free everywhere in these areas. Cities shown in green have their own page, with the distance from our yard and the usual pickup window.",
